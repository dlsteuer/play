...
The following terms and conditions (the “Agreement”) govern all use of the battlesnake.io website and all corresponding subdomains (the "Site") and the products and services availabe the Site (taken together with the Site, the “Service”).  The Service is owned and operated by Battlesnake Inc. (“Battlesnake”). The Service is offered subject to your (and the organization you represent) (together, “User”) acceptance without modification of all of the terms and conditions contained herein and all other operating rules, policies and procedures that may be published from time to time on the Site by Battlesnake Inc.
...
### 15. CONTACT
Questions regarding this Agreement should be directed to legal@battlesnake.io or by mailing Battlesnake at the following address:
